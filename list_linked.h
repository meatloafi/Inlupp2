...
/// @return an empty linked list with a nullified first and last link and length of 1
...
/// @param element the element in the new link
/// @param next the next of that link
/// @return the new link
